...
const EditarEmpresa = () => {
  ...
  const getPaisNombreById = (idNum) => {
    return (
      Object.keys(configuracionPaises).find(
        (key) => configuracionPaises[key].paisId === Number(idNum)
      ) || ""
    );
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `http://127.0.0.1:8000/api/actualizar-empresa/${id}/`,
        {
          method: "PUT",
          headers: {
            Authorization: `Bearer ${token}`, // ✅ JWT
            ...
            <form className="company-form" onSubmit={handleSubmit}>
              ...
              <div className="form-section">
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "15px" }}>
                  ...
                  <span className="upload-link" style={{ fontSize: "14px" }}>
